                    ...
                    <thead>
                        ...
                        <tr>
                            <th class="align-middle">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input wire:model="searchByName" type="search" placeholder="Buscar por nombre"
                                            class="form-control form-control-sm">
                            </th>
                            <th class="align-middle">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input wire:model="searchByLastname" type="search"
                                            placeholder="Buscar por apellido" class="form-control form-control-sm">
                            </th>
                            <th class="align-middle">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input wire:model="searchByEmail" type="search" placeholder="Buscar por e-mail"
                                            class="form-control form-control-sm">
                            </th>
                            <th class="align-middle">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <input wire:model="searchByOrden" type="search" placeholder="Buscar por roles"
                                            class="form-control form-control-sm">
                            </th>
                            ...
                            <th class="text-center align-middle">
                                <button wire:click="resetSearchFields" class="btn btn-sm btn-secondary">Limpiar
                                    Búsqueda</button>
                            </th>
                        </tr>
                    </thead>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 mb-2">
                                    ...
                                    <div class="input-group mb-2 mr-sm-2">
                                        ...
                                        <input type="number" class="form-control" name="orden" min="1"
