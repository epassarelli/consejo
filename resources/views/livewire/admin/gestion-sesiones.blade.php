                        ...
                        @foreach ($sesiones as $sesion)
                            <tr>
                                ...
                                <td class="p-1 text-center">
                                    <button wire:click="edit({{ $sesion->id }})" class="btn btn-sm btn-primary"
                                    ...
                                    <button wire:click="notificar({{ $sesion->id }})" class="btn btn-sm btn-warning"
                                        data-toggle="modal" data-target="#roleModal" title="notificar"><i
                                            class="far fa-bell"></i></button>

                                    <button wire:click="descargarPdf({{ $sesion->id }})" class="btn btn-sm btn-danger"
                                        data-toggle="modal" data-target="#roleModal" title="Descargar pdf"><i
                                            class="far fa-file-pdf"></i></button>

                                    <button wire:click="iniciarSesion({{ $sesion->id }})"
                                        class="btn btn-sm btn-secondary" data-toggle="modal" data-target="#roleModal"
                                        title="Iniciar sesión"><i class="fas fa-users"></i></button>
                            ...
                            <div class="row">
                                <div class="col-12 mb-2">
                                    ...
                                    <div class="input-group mb-2 mr-sm-2">
                                        ...
                                        <input type="text" class="form-control" name="urlYoutube" id="urlYoutube"
